...
const Loginpage = () => {
  ...
  return (
    ...
    min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      w-full sm:w-96 text-indigo-300 text-sm' >
        ...
        <form onSubmit={onSubitHandler}>
          ...
          <p onClick={()=>navigate('/resetpassword')}className='mb-4 text-indigo-500 cursor-pointer'>
            Forgot Password?
          </p>

          <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-400 to-indigo-800 *:text-white font-medium'>
            {state}</button>
        </form>
